...
#[derive(Debug)]
pub struct ApiMockProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ApiMockProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ApiMock processing");
    
    let mut processor = ApiMockProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ApiMockProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ApiMockProcessor::new(false);
